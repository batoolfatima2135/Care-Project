                ...
                <div class="col-sm-12 col-lg-10 offset-lg-1">
                    ...
                    <form action="{{Route('doctor.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="form-group">
                                <label>Address</label>
                                <textarea name="address" cols="20" rows="4"  placeholder="your address" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Address'" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Qualification</label>
                                <textarea name="qualification" cols="20" rows="4"  placeholder="your Qualification" onfocus="this.placeholder = ''" onblur="this.placeholder = 'your Qualification'" required></textarea>
                            </div>
                            <div class="form-group">
                                <label>Profile description</label>
                                <textarea name="about" cols="20" rows="7"  placeholder="Tell us about yourself" onfocus="this.placeholder = ''" onblur="this.placeholder = 'profile description'" required></textarea>
                            </div>
